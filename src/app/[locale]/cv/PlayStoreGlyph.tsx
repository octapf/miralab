/**
 * Icono Google Play 2022 (formas y colores de marca). Fuente: Wikimedia Commons / identidad Google Play.
 */
export default function PlayStoreGlyph({ className }: { className?: string }) {
  return (
    <svg
      className={className}
